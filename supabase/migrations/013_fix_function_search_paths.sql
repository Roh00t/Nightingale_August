...
-- ============================================================
-- Problem: 6 functions have mutable search_path which is flagged
-- as a security warning by Supabase linter.
--
-- Solution: Recreate each function with SET search_path = public
-- to prevent search_path manipulation attacks.
-- ============================================================

-- 1. Fix get_user_clinic_id
...
BEGIN
  ...
  INSERT INTO public.timeline_entries (id, care_note_id, author_role, author_id, entry_type, content, content_text, risk_level, visibility, created_at) VALUES
    ...
    -- February 2026: AI-scribed consult summary
  ...
  -- Highlights
  INSERT INTO public.highlights (care_note_id, source_entry_id, content_snippet, risk_reason, risk_level, importance_score, provenance_pointer, created_at) VALUES
  ...
  -- Version history
  INSERT INTO public.note_versions (care_note_id, version_number, content_snapshot, changed_by, change_summary, created_at) VALUES
  ...
  -- Comments
  INSERT INTO public.comments (care_note_id, timeline_entry_id, author_id, author_role, content, created_at) VALUES
  ...
  INSERT INTO public.interaction_log (user_id, user_role, action_type, target_type, target_id, target_metadata, created_at) VALUES
    (clinician_id, 'clinician', 'accept', 'highlight', (SELECT id FROM public.highlights WHERE content_snippet LIKE '%eGFR dropped%' LIMIT 1),
     '{"keywords": ["eGFR", "kidney", "decline"], "topic": "renal_function"}', '2026-01-15 11:10:00+08'),
    (clinician_id, 'clinician', 'pin', 'highlight', (SELECT id FROM public.highlights WHERE content_snippet LIKE '%Cardiology referral%' LIMIT 1),
     '{"keywords": ["referral", "cardiology", "pending"], "topic": "referral_tracking"}', '2026-01-16 09:00:00+08'),
    (clinician_id, 'clinician', 'accept', 'highlight', (SELECT id FROM public.highlights WHERE content_snippet LIKE '%dyspnea%' LIMIT 1),
