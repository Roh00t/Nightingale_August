...
**Verification basis:** 429 tests pass (`cd ai-service && .venv/bin/python -m pytest tests/ -q`);
...
remaining gap named in each. 429 tests pass; delivery semantics and retraction
