...
**349 automated tests · Glance P95 79.7 ms · runs offline with no credentials.**
...
Expect **349 passed**. The suites build an ephemeral PostgreSQL cluster, apply
...
```bash
npm test                     # 349 pytest tests (uses ai-service/.venv)
