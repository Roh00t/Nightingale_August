...
**429 automated tests · Glance P95 79.7 ms · suite runs offline with no credentials.**
...
Expect **429 passed**. The suites build an ephemeral PostgreSQL cluster, apply
...
```bash
npm test                     # 429 pytest tests (uses ai-service/.venv)
