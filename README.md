...
**379 automated tests · Glance P95 79.7 ms · runs offline with no credentials.**
...
Expect **379 passed**. The suites build an ephemeral PostgreSQL cluster, apply
...
```bash
npm test                     # 379 pytest tests (uses ai-service/.venv)
